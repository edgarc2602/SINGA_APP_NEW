<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RH_Rep_contrato.aspx.vb" Inherits="App_RH_RH_Rep_contrato" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>CONTRATO DE EMPLEADOS</title>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                var formula = '{tb_empleado.id_status}=2 and {tb_empleado.id_cliente}=130 and {tb_estado_1.id_estado} =' + $('#dlestado').val()
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Contrato de personal<small>RH</small></h1>
                    <ol class="breadcrumb">
