<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RH_Rep_Empleadosxreclutador.aspx.vb" Inherits="App_RH_RH_Rep_Empleadosxreclutador" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                var formula = '{tb_empleado.fingreso} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')'
                window.open('../RptForAll.aspx?v_nomRpt=empleadoxreclutador.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
    </script>
</head>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte de Empleados por reclutador<small>RH</small></h1>
                    <ol class="breadcrumb">
