...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
                                                ...
                                                if (res != 0) {
                                                    ...
                                                    PageMethods.buscarcuenta($('#txcuenta').val(), $('#txid').val(), function (res) {
                                                        if (res != 0) {
                                                            ...
                                                            xmlgraba += ' jornal= "' + $('#txjornal').val() + '" apellidop= "' + $('#txpaterno').val() + '" apellidom = "' + $('#txmaterno').val() + '" nombre= "' + $('#txnombre').val() + '"';
                                                            xmlgraba += ' rfc= "' + $('#txrfc').val() + '" curp= "' + $('#txcurp').val() + '" ss = "' + $('#txss').val() + '" fnac= "' + fnac + '"';
                                                            xmlgraba += ' lugar= "' + $('#txlugar').val() + '" nacion = "' + $('#txnacion').val() + '" genero= "' + $('#dlgenero').val() + '"';
        ...
        function calculaRFC() {
            ...
            if ((n1 == 'JOSE' || n1 == 'MARIA') && n1.length != 0) {
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-1">
                                        <label for="txlugar">Lugar de nacimiento:</label>
                                    </div>
                                    <div class="col-lg-2">
