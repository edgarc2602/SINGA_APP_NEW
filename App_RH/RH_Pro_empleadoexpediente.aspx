<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RH_Pro_empleadoexpediente.aspx.vb" Inherits="App_RH_RH_Pro_empleadoexpediente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>CARGA EXPEDIENTE DE EMPLEADO</title>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        PageMethods.actualiza($('#txempleado').val(), res, function (res) {
                            alert('El expediente se ha cargado correctamente');
                            cargalista();
                            closeWaitingDialog();
                            dialog.dialog('close');
                        }, iferror);
                        ...
                        <table class="table table-condensed h6" id="tbdatos">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-navy"><span>Expediente</span></th>
