...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        ...
        #tblista tbody td:nth-child(12), #tblista tbody td:nth-child(13),#tblista tbody td:nth-child(14),#tblista tbody td:nth-child(15){
            width:0px;
            display:none;
        }
    </style>
        ...
        $(function () {
            ...
            $('#btguarda').on('click', function () {
                if (valida()) {
                    ...
                    xmlgraba += ' idemp="0" coordina=" ' + $('#idcoordina').val() + '" vacantesi="1" plantilla= "' + $('#idplantilla').val() + '" posicion= "' + $('#posicion').val() + '" />'
                    var f = new Date();
                    var mm = f.getMonth() + 1
        ...
        function cargainmueble(idcte) {
            PageMethods.inmueble(idcte, function (opcion) {
                ...
                $('#dlsucursal').change(function () {
                    cargapuesto($('#dlsucursal').val());
                    cargadatosinm($('#dlsucursal').val());
                });
            }, iferror);
        }
        function cargaestructura() {
            PageMethods.estructura($('#dlsucursal').val(), $('#dlpuesto').val(), $('#dlturno').val(),  function (res) {
                var ren = $.parseHTML(res);
                $('#tblista table tbody').remove();
                $('#tblista table').append(ren);
                $('#tblista table tbody tr').on('click', function () {
                    if (parseInt($(this).children().eq(14).text()) == 0) {
                        if (parseInt($(this).children().eq(10).text()) == 0) {
                            $('#txpuesto').val($(this).children().eq(2).text());
                            $('#txturno').val($(this).children().eq(3).text());
                            $('#txpago').val($(this).children().eq(8).text());
                            $('#txforma').val($(this).children().eq(5).text());
                            $('#txtipon').val($(this).children().eq(6).text());
                            $('#txsexo').val($(this).children().eq(7).text());
                            $('#txjornal').val($(this).children().eq(4).text());
                            $('#idplantilla').val($(this).children().eq(0).text());
                            $('#posicion').val($(this).children().eq(1).text());
                            $('#idpuesto').val($(this).children().eq(11).text());
                            $('#idturno').val($(this).children().eq(12).text());
                            cargaplantilla($(this).children().eq(0).text())
                            $('#dvvacante').toggle('slide', { direction: 'down' }, 500);
                            $('#tblista').hide();
                        } else {
                            alert('Ya existe una vacante creada para esta posicion, debe cancelar la vacante para proceder');
                        }
                        
                    } else {
                        alert('Esta plantilla no esta disponible para generar vacante, debe aplicar la baja del personal asignado para proceder'); 
                    }
                ...
                <div class="content">
                    <div class="row" id="dvdatos">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="col-md-18 tbheader" id="tblista" style="height:300px; overflow-y:scroll">
                                    <table class="table table-condensed">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-light-blue-gradient"><span>Cubierto por</span></th>
