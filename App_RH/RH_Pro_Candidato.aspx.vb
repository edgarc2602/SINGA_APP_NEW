...
Partial Class App_RH_RH_Pro_Candidato
    ...
    <Web.Services.WebMethod()>
    Public Shared Function reclutador() As String
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim sqlbr As New StringBuilder
        Dim sql As String = ""

        sqlbr.Append("select id_empleado, paterno + ' ' + rtrim(materno) + ' ' + nombre as nombre from" & vbCrLf)
        sqlbr.Append("tb_empleado  where id_status  = 2 and id_puesto = 26 order by paterno, materno, nombre" & vbCrLf)
        Dim da As New SqlDataAdapter(sqlbr.ToString, myConnection)
        Dim dt As New DataTable
        da.Fill(dt)
        sql = "["
    ...
    Public Shared Function guarda(ByVal registro As String) As String
        ...
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim mycommand As New SqlCommand("sp_empleadoAPP", myConnection)
