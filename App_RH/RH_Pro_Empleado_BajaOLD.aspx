...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        #tblista tbody td:nth-child(8),#tblista tbody td:nth-child(9),#tblista tbody td:nth-child(11){
            width:0px;
            display:none;
        }
        .cb{
                ...
                if (valida()) {
                    ...
                    PageMethods.validaposiciones($('#idplantilla').val(), $('#txidemp').val(), vacante, function (detalle) {
                        ...
                        if (parseInt(datos.activos) >= parseInt(datos.espacios)) {
                            ...
                            xmlgraba += ' idemp = "' + $('#txidemp').val() + '" fbaja = "' + finicio + '" coordina = "' + $('#idcoordina').val() + '" vacantesi= "' + vacante + '" motivo= "' + $('#dlmotivo').val() + '" plantilla= "' + $('#idplantilla').val() + '" comentbaja= "' + $('#txcomentbaja').val() + '"/>'
