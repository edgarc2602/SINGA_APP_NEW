...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        ...
        #tblista1 tbody td:nth-child(11),#tblista1 tbody td:nth-child(12),#tblista1 tbody td:nth-child(13),#tblista1 tbody td:nth-child(14){
            width:0px;
            display:none;
        }
            */ 
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#cbvacante').click(function () {
                if ($('#cbvacante').is(':checked')) {
                    $('#dvvacante').show();
                    PageMethods.horarios($('#idplantillao').val(), function (detalle) {
        ...
        function ejecutatrans() {
            ...
            xmlgraba += ' sueldo= "' + $('#sueldo').val() + '" idemp = "' + $('#txidemp').val() + '" usuario = "' + $('#idusuario').val() + '" inmuebleo = "' + $('#dlsucursal').val() + '" posicion = "' + $('#posicion').val() + '" vacante = "' + $('#vacante').val() + '" plantillao = "' + $('#idplantillao').val() + '" posiciono = "' + $('#posiciono').val() + '" />';
            var f = new Date();
            var mm = f.getMonth() + 1
            ...
            PageMethods.guarda(xmlgraba, fecha, $('#lbemp').val() + ' ' + $('#lbnombre').val(), $('#lbtransfierede').val(), $('#lbtransfierea').val(), $('#idusuario').val(), $('#idgerente').val(), function () {
                var vacante = 0
                if ($("#cbvacante").is(':checked')) {
                    vacante = 1
                    var f = new Date();
                    ...
                    var fecha = f.getDate() + "/" + mm + "/" + f.getFullYear();
                    var xmlgraba = '<vacante id= "0" tipo = "1" cliente = "' + $('#dlcliente').val() + '" inmueble= "' + $('#dlsucursal').val() + '" ubicacion ="1" puesto = "' + $('#idpuesto').val() + '" turno = "' + $('#idturno').val() + '" ';
                    xmlgraba += ' experiencia= "' + $('#txexperiencia').val() + '" observacion= "' + $('#txobservacion').val() + '" usuario="' + $('#idusuario').val() + '" ';
                    xmlgraba += ' idemp = "0" coordina = "' + $('#idcoordina').val() + '" vacantesi= "' + vacante + '" plantilla= "' + $('#idplantillao').val() + '" posicion ="' + $('#posiciono').val() + '"/>'
                    PageMethods.guardavacante(xmlgraba, fecha, $('#dlcliente option:selected').text(), $('#txpuesto').val(), $('#dlsucursal option:selected').text(), $('#dlubicacion option:selected').text(), $('#txdefinicion').val(), $('#dlcliente').val(), function (res) {
                        closeWaitingDialog();
        ...
        function cargaestructura() {
            PageMethods.estructura($('#dlsucursal1').val(), function (res) {
                ...
                $('#tblista1 tbody tr').on('click', function () {
                    //alert($(this).children().eq(13).text());
                    if (parseInt($(this).children().eq(13).text()) == 0) {
                        ...
                        $('#jornal').val($(this).children().eq(4).text())
                        $('#pago').val($(this).children().eq(12).text())
                        $('#sueldo').val($(this).children().eq(7).text())
                        $('#posicion').val($(this).children().eq(1).text())
                        $('#vacante').val($(this).children().eq(9).text())
                        ...
                        var transa = $('#dlcliente1 option:selected').text() + ', ' + $('#dlsucursal1 option:selected').text() + ', ' + $(this).children().eq(2).text() + ', ' + $(this).children().eq(3).text() + ', jornal: ' + $(this).children().eq(4).text() + ', ' + $(this).children().eq(5).text() + ', ' + $(this).children().eq(7).text()
        ...
        function cargalista() {
            PageMethods.empleados($('#dlsucursal').val(), $('#txnombrebusca').val(), function (res) {
                ...
                $('#tblista tbody tr').on('click', function () {
                    ...
                    $('#idplantillao').val($(this).children().eq(8).text());
                    //alert($(this).children().eq(10).text());
                    $('#posiciono').val($(this).children().eq(9).text());
                    $('#tblista').hide();
                    $('#dvdatos').show();
                    limpiavacante();
                    limpia();
...
<body class="skin-blue sidebar-mini">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="idplantillao" runat="server" />
        <asp:HiddenField ID="posiciono" runat="server" />
        ...
        <asp:HiddenField ID="vacante" runat="server" />
        <div class="wrapper">
                        ...
                        <div id="dvdatos">
                            <div class="row">
                                ...
                                <div class="col-lg-1 text-right">
                                    <label for="txidemp">No. Emp.:</label>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row">
                                <div>
                                    <div class="col-lg-6 text-center">
                                        <input type="checkbox" id="cbvacante" class="cb"/><label for="cbvacante" style="font-size:20px;">La Transferencia genera vacante</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="dvvacante">
                                <div class="row">
                                    <div class="col-lg-2 text-right">
                                        <label for="txdefinicion">Datos para vacante:</label>
                                    </div>
                                    <div class="col-lg-8">
                                ...
                                <table class="table table-condensed">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-light-blue-gradient"><span>Posición</span></th>
                                            ...
                                            <th class="bg-light-blue-gradient"><span>Ocupado por</span></th>
                                            <th class="bg-light-blue-gradient"><span>Vacante</span></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
