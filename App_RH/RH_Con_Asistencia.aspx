    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btmostrar').click(function () {
                ...
                if (valida()) {
                    //alert('hola');
                    window.open('RH_Descarga_Asistencia.aspx?cliente=' + $('#dlcliente').val() + '&tipo=' + $('#dltipo').val() + '&fecini=' + $('#txfecini').val() + '&fecfin=' + $('#txfecfin').val() + '&gerente=' + $('#dlgerente').val() + '&ejecutivo=' + $('#dlejecutivo').val(), '_blank');
                }
            })
        ...
        function valida() {
            ...
            if ($('#dltipo').val() == 0) {
                alert('Debe elegir el tipo de nomina');
                return false;
            }
            if ($('#dltipo').val() == 6 && $('#idusuario').val() != 1) {
                alert('Usted no esta autorizado para consultar este tipo de nómina');
                return false;
            }
            if ($('#txfecini').val() == "") {
                alert('Debe elegir la fecha inicial');
                return false;
            }
            if ($('#txfecfin').val() == "") {
                alert('Debe elegir la fecha inicial');
        ...
        function cargaejecutivo() {
            PageMethods.ejecutivo(0, function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
                            ...
                            <div class="box box-info">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 text-right">
                                        <label for="dltipo">Tipo de Nómina:</label>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 text-right">
                                        <label for="dlejecutivo">Ejecutivo CGO:</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <select id="dlejecutivo" class="form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-1 right">
                                        <input type="button" class="btn btn-primary" value="Exportar a Excel" id="btmostrar" />
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
