...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        ...
        function cuentaempleado() {
            ...
            PageMethods.contarempleado(per, $('#dlcliente').val(), $('#dlsucursal').val(), $('#dlturno').val(), $('#txempleado').val(), $('#txnoemp').val(), function (cont) {
        ...
        function cargalista() {
            ...
            PageMethods.empleado($('#dlcliente').val(), $('#dlsucursal').val(), $('#txfecha').val(), $('#dlestado').val(), per, $('#hdpagina').val(), $('#dlturno').val(), $('#txempleado').val(), $('#txnoemp').val(), function (res) {
                closeWaitingDialog();
