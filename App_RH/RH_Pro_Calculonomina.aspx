...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
                ...
                if ($('#dlperiodo').val() != 0) {
                    if (validaproceso()) {
                        ...
                        */
                        ...
                        /*
                        PageMethods.nominareporte($('#dlperiodo').val(), tipo, anio, $('#dltipo').val(), finicio, ffinal, vforma, function () {
                        //    closeWaitingDialog();
                            /*
                            var periodo = $('#dlperiodo option:selected').text()
                ...
                if (validaproceso()) {
                    if ($('#dlperiodo').val() != 0) {
                        ...
                        if (r == true) {
                            ...
                            var anio = $("#dlperiodo option:selected").text().substring(3, 7);
                            PageMethods.cerrar($('#dlperiodo').val(), per, anio, $('#dltipo').val(), $("#dltipo option:selected").text(), function (res) {
        ...
        function validaproceso() {
            if ($('#dltipo').val() == 6) {
                if (($('#idusuario').val() != 1 && $('#idusuario').val() != 171 && $('#idusuario').val() != 100)) {
        ...
        */
        ...
        function procesanomina() {
            if (valida()) {
                ...
                /*var difdias = ffinal.diff(finicio, 'days');
                alert(difdias);*/
