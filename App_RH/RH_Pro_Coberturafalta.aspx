        ...
        $(function () {
            ...
            $('#btguarda').click(function () {
                ...
                for (var x = 0; x < $('#tblista tbody tr').length; x++) {
                    //alert($('#tblista tbody tr').eq(x).find('td').eq(10).text()); //&& $('#tblista tbody tr').eq(x).find('td').eq(10).text() == '0'
        ...
        function cargalistaemp() {
            PageMethods.listaempleado($('#dltipo').val(),$('#txbusca').val(), function (res) {
                ...
                $('#tbbusca tbody tr').click(function () {
                    ...
                    $('#tblista tbody tr').eq($('#tbfila').val()).find('td').eq(10).text('<a href="../RH_Con_Empleado_completo.aspx">../RH_Con_Empleado_completo.aspx</a>');
