...
Imports System.Xml
Partial Class App_RH_RH_Pro_Aguinaldo
    ...
    Public Shared Function procesado(ByVal anio As Integer, ByVal tipo As Integer) As String
        ...
        sqlbr.Append("select isnull(id_status,0) estatus, importe, case when id_status = 1 then 'Abierto' when id_status = 2 then 'Cerrado' when id_status = 3 then 'liberado' when id_status = 4 then 'Pagado' end as estado from tb_calculoaguinaldog where anio = " & anio & " and id_area = " & tipo & "")
    ...
    Public Shared Function procesa(ByVal registro As String) As String
        ...
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim mycommand As New SqlCommand("sp_calculoaguinaldo", myConnection)
    ...
    Public Shared Function cerrar(ByVal anio As Integer, ByVal tipo As Integer, ByVal desctipo As String) As String
        ...
        sql = "Update tb_calculoaguinaldog set id_status = 2 where anio = " & anio & " and id_area ='" & tipo & "';"
        ...
        generacorreo.cierreaguinaldo(anio, desctipo)
