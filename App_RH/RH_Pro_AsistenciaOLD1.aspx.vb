...
Partial Class App_RH_RH_Pro_Asistencia
    ...
    <Web.Services.WebMethod()>
    Public Shared Function contarempleado(ByVal forma As String, ByVal cliente As String, ByVal inmueble As String, ByVal turno As Integer, ByVal nombre As String, ByVal noemp As String) As String
        Dim sqlbr As New StringBuilder
        Dim sql As String = ""
    ...
    <Web.Services.WebMethod()>
    Public Shared Function empleado(ByVal cliente As Integer, ByVal inmueble As Integer, ByVal fecha As String, ByVal estado As Integer, ByVal forma As Integer, ByVal pagina As Integer, ByVal turno As Integer, ByVal nombre As String, ByVal noemp As String) As String
        ...
        sqlbr.Append("select ROW_NUMBER()Over(Order by e.nombre, a.paterno, a.materno, a.nombre) As RowNum, e.id_inmueble, e.nombre as sucursal, isnull(e.tel1,'') as telefono, a.id_empleado, paterno + ' ' + rtrim(materno) + ' ' + a.nombre as empleado," & vbCrLf)
