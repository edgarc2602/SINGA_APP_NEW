<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RH_Pro_Aguinaldo.aspx.vb" Inherits="App_RH_RH_Pro_Aguinaldo" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btcerrar').click(function () {
                if (validaproceso()) {
                    if ($('#txestatus').val() == 'Abierto') {
                        var r = confirm("El cierre de Aguinaldo ya no permite realizar cambios al cálculo actual, ¿estas seguro de continuar?");
                        if (r == true) {
                            PageMethods.cerrar($('#txanio').val(), $('#dltipo').val(), $('#dltipo option:selected').text(), function () {
                                $('#txestatus').val('Cerrado');
                                alert('El aguinaldo ha sido cerrada, ya no se pueden realizar movimientos');
                            }, iferror);
                        } else { alert('No se ejecuta cierre'); }
                    } else {
                        alert('Solo se puede cerrar el proceso de aguinaldo cuando se encuentra en estatos abierto, no puede continuar')
                    }
                }
            })
            $('#btcalcular').click(function () {
                if ($('#txestatus').val() != 'Abierto') {
                    alert('El proceso de aguinaldo ya ha sido cerrado, no puede recalcular')
                } else {
                    procesaaguinaldo();
                    cargaaguinaldo()
                }
        ...
        function procesaaguinaldo() {
            //waitingDialog({});
            var fecha1 = $('#txfecha').val().split('/');
            var finicio = fecha1[2] + fecha1[1] + fecha1[0];
            xmlgraba = '<procesa anio="' + $('#txanio').val() + '" fini="' + finicio + '"  tipo="' + $('#dltipo').val() + '" />';
        ...
        function validaproceso() {
            ...
            if ($('#dltipo').val() == 6) {
                if (($('#idusuario').val() != 1 && $('#idusuario').val() != 100)) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Cálculo de Aguinaldo<small>Recursos Humanos</small></h1>
                    <ol class="breadcrumb">
                ...
                <div class="content">
                    <div class="row" id="dvdatos">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li id="btcerrar" class="puntero"><a><i class="fa fa-save"></i>Cerrar Aguinaldo</a></li>
