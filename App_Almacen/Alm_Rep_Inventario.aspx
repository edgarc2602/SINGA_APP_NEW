<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Alm_Rep_Inventario.aspx.vb" Inherits="App_Almacen_Alm_Rep_Inventario" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                var formula = '{tb_inventario.id_status} = 1 and {tb_almacen.id_almacen}=' + $('#dlalmacen').val()
                window.open('../RptForAll.aspx?v_nomRpt=inventarioalmacen.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte de inventarios<small>Compras</small></h1>
                    <ol class="breadcrumb">
