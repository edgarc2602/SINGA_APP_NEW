<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Alm_Rep_listadoporruta.aspx.vb" Inherits="App_Almacen_Alm_Rep_listadoporruta" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                var formula = '{tb_listadomaterial.id_status} <> 5 and { tb_listadomaterial.anio } =' + $('#txanio').val() + ' and {tb_listadomaterial.mes} = ' + $('#dlmes').val() + ' and {tb_ruta.id_ruta} = ' + $('#dlruta').val()
                
               // alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=listadoporruta.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
        function cargaruta() {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Listados agrupados por ruta<small>Almacén</small></h1>
                    <ol class="breadcrumb">
