...
Imports System.Xml
Partial Class App_Almacen_Alm_Pro_Solicitudmaterial
    ...
    Public Shared Function almacen() As String
        ...
        sqlbr.Append("select id_almacen, rtrim(nombre) as nombre from tb_almacen where id_almacen = 1 order by id_almacen")
    ...
    Public Shared Function productol(ByVal desc As String, ByVal almacen As Integer) As String
        ...
        sqlbr.Append("where b.id_servicio <> 1 and b.descripcion like '%" & desc & "%' and a.id_almacen =" & almacen & " for xml path('tr'), root('tbody')")
    ...
    Public Shared Function solicitud(ByVal idsol As String) As String
        ...
        sqlbr.Append("select id_almacen, id_cliente, convert(varchar(12), falta, 103) as falta, solicita, " & vbCrLf)
        ...
        da.Fill(dt)
        If dt.Rows.Count > 0 Then
            sql += "{almacen:'" & dt.Rows(0)("id_almacen") & "', cliente:'" & dt.Rows(0)("id_cliente") & "', fecha:'" & dt.Rows(0)("falta") & "',"
    ...
    Public Shared Function cargadetalle(ByVal idsol As Integer, ByVal almacen As Integer) As String
        ...
        sqlbr.Append("select clave as 'td','','' as 'td','', producto as 'td','', unidad as 'td','', cast(existencia as numeric(12,2)) as 'td',''," & vbCrLf)
        ...
        sqlbr.Append("from( select a.clave, c.descripcion as producto, d.descripcion as unidad,  cantidad, precio, e.existencia" & vbCrLf)
        ...
        sqlbr.Append("inner join tb_inventario e on a.clave = e.clave and id_almacen = " & almacen & "")
