...
Partial Class App_Almacen_Alm_Con_Solicitudmaterial
    ...
    <Web.Services.WebMethod()>
    Public Shared Function solicitudes(ByVal fini As String, ByVal ffin As String, ByVal cli As Integer, ByVal est As Integer, ByVal pagina As Integer, ByVal folio As Integer) As String
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim sqlbr As New StringBuilder
        ...
        sqlbr.Append("select id_solicitud as 'td','', falta as 'td','', almacen as 'td','', cliente as 'td','', estatus as 'td',''," & vbCrLf)
        ...
        sqlbr.Append("case when id_status =1 then " & vbCrLf)
        ...
        sqlbr.Append(" when id_status = 3 then" & vbCrLf)
        sqlbr.Append("(select 'btn btn-primary btauto' as '@class', 'Autorizar/Rechazar' as '@value', 'button' as '@type' for xml path('input'),type)" & vbCrLf)
        sqlbr.Append("end as 'td','', id_almacen as 'td','', id_cliente as 'td'" & vbCrLf)
        ...
        sqlbr.Append("e.descripcion as estatus, convert(varchar(12), falta,103) as falta , a.solicita, a.id_status, a.id_almacen, a.id_cliente, " & vbCrLf)
