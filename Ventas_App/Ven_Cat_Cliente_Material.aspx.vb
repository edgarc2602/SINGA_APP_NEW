...
Imports System.Xml
Partial Class Ventas_App_Ven_Cat_Cliente_Material
    ...
    Public Shared Function materiales(ByVal cliente As Integer) As String
        ...
        sqlbr.Append("select a.id_material as 'td','', b.descripcion as 'td','', c.descripcion as 'td','', d.descripcion as 'td','', cast(a.importe as numeric(12,2)) as 'td',''," & vbCrLf)
    ...
    <Web.Services.WebMethod()>
    Public Shared Function concepto(ByVal linea As Integer) As String
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim sqlbr As New StringBuilder
        Dim sql As String = ""
        sqlbr.Append("select id_concepto, descripcion from tb_conceptoptto where id_lineanegocio = " & linea & " order by descripcion")
        Dim da As New SqlDataAdapter(sqlbr.ToString, myConnection)
        Dim dt As New DataTable
        da.Fill(dt)
        sql = "["
    ...
    Public Shared Function guarda(ByVal registro As String) As String
        ...
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim mycommand As New SqlCommand("sp_material", myConnection)
    ...
    <Web.Services.WebMethod()>
    Public Shared Function elimina(ByVal material As Integer) As String

        Dim sql As String = "Update tb_cliente_material set id_status = 2 where id_material =" & material & ";"
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
