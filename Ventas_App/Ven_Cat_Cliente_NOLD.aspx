    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btplantilla').on('click', function () {
                var mywin = window.open('Ven_Cat_Cliente_Plantilla.aspx?id=' + $('#txid').val() + '&nombre=' + $('#txnombre').val(), '_blank', 'top = 100, left = 100, width = 1200, height = 500')
            });
            ...
            $('#btguarda').on('click', function () {
                if (valida()) {
                    ...
                    xmlgraba += ' ptmat= "' + $('#txpmat').val() + '" ptind= "' + $('#txpind').val() + '" '; 
        ...
        function cargalista() {
            PageMethods.cliente($('#hdpagina').val(), $('#dlbusca').val(), $('#txbusca').val(),  function (res) {
        ...
        function datoscliente() {
            PageMethods.detalle($('#txid').val(), function (detalle) {
                ...
                PageMethods.galleta($('#txid').val(), function () {

                });
            }, iferror);
        };
        function cargaejecutivo() {
            PageMethods.empleado(6,'esejecutivo', function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
                    ...
                    <div class="row" id="dvdatos">
                        <div class="col-md-10">
                            ...
                            <div class="box box-info     ">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 text-right">
                                        <label for="dlencargado">Encargado OP:</label>
                                    </div>
                                    <div class="col-lg-4">
