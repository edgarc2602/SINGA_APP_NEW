<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ven_Cat_Cliente_Herramienta.aspx.vb" Inherits="Ventas_App_Ven_Cat_Cliente_Herramienta" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btagrega').click(function () {
                if (validaherramienta()) {
                    ...
                    var xmlgraba = '<herramienta cliente= "' + $('#idcte').val() + '" linea= "' + $('#dllinea').val() + '" periodo ="' + $('#dlperiodo').val() + '" concepto = "' + $('#txconcepto').val() + '"';
        ...
        function cargaherramienta() {
            PageMethods.herramientas($('#idcte').val(), function (res) {
                var ren = $.parseHTML(res);
                $('#tbherramienta tbody').remove();
                $('#tbherramienta').append(ren);
                $('#tbherramienta tbody tr').on('click', '.btborrar', function () {
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="content-header">
                <h1>Presupuesto de Herramienta y Eq.: <span id="txctenom"></span></h1>
            </div>
            <div class="content">
                <div class="col-md-11 tbheader">
                    <table class="table table-condensed" id="tbherramienta">
                        <thead>
                            <tr>
                                <th class="bg-navy"></th>
