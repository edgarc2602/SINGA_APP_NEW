        ...
        $(function ()
        {
            ...
            $('#btimprime').click(function ()
            {
                if (valida())
                {
                    ...
                    var formula = '';
                    formula = '{tb_cliente.id_cliente} =' + $('#dlcliente').val() + ' and {tb_factura.fecha_emision_docto} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')';
                    console.log(formula);
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte de pagos facturación por cliente<small>Compras</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../Home.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li>Compras</li>
                        <li class="active">Consulta de pagos facturación</li>
                    </ol>
                </div>
                <div class="content">
