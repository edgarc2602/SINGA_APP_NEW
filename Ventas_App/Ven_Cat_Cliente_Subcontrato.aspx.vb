...
Partial Class Ventas_App_Ven_Cat_Cliente_Subcontrato
    ...
    Public Shared Function subcontratos(ByVal cliente As Integer) As String
        ...
        sqlbr.Append("select a.id_subcontrato as 'td','', b.descripcion as 'td','', c.descripcion as 'td','', a.concepto as 'td','', cast(a.importe as numeric(12,2)) as 'td',''," & vbCrLf)
    ...
    Public Shared Function guarda(ByVal registro As String) As String
        ...
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim mycommand As New SqlCommand("sp_subcontrato", myConnection)
    ...
    Public Shared Function elimina(ByVal herr As Integer) As String
        ...
        Dim sql As String = "Update tb_cliente_subcontrato set id_status = 2 where id_subcontrato =" & herr & ";"
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
