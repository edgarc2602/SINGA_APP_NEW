<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ven_Cat_Cliente_encargado.aspx.vb" Inherits="Ventas_App_Ven_Cat_Cliente_encargado" %>
    ...
    <script type="text/javascript">
         ...
         $(function () {
             ...
             $('#btagrega').click(function () {
                 PageMethods.actualiza($('#dltipo').val(), $('#dlempleado').val(), $('#dlcliente').val(), function (res) {
                     $('#dlcliente').val(0);
                     cargalista();
                 }, iferror);
             })
             $('#btejecuta').click(function () {
                 PageMethods.ejecuta($('#dltipo').val(), $('#dlempleado1').val(), $('#dlempleado').val(), function (res) {
                    cargalista();
                 }, iferror);
             })
             $('#btimprime').click(function () {
                 window.open('../RptForAll.aspx?v_nomRpt=clienteencargados.rpt&v_formula={tb_cliente.id_status} = 1', '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
             });
         })
        function cargaempleado() {
            PageMethods.empleado($('#dltipo').val(), function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
        ...
        function cargalista() {
            PageMethods.cliente($('#dlempleado').val(), $('#dltipo').val(), function (res) {
                var ren1 = $.parseHTML(res);
                $('#tblista tbody').remove();
                $('#tblista').append(ren1);
                $('#tblista').delegate("tr .btquita", "click", function () {
                    PageMethods.elimina($(this).closest('tr').find('td').eq(2).text(), function (res) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Encargados asignados por Cliente<small>Ventas</small></h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="box box-info     ">
                            ...
                            <div class="row">
                                <div class="col-lg-1 text-right">
                                    <label for="dltipo">Area:</label>
                                </div>
                                <div class="col-lg-2 text-right">
                                    <select id="dltipo" class="form-control">
                                        <option value="0">Seleccione...</option>
                                        <option value="53">Compras</option>
                                        <option value="30">Limpieza</option>
                                        <option value="107">Mantenimiento</option>
                                        <option value="39">Recursos Humanos</option>
                                        <option value="66">Facturación</option>
                                    </select>
                                </div>
                                <div class="col-lg-1 text-right">
                                    <label for="dlempleado">Encargado:</label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 text-right">
                                    <label for="txclave">Cambiar todo al encargado</label>
                                </div>
                                <div class="col-lg-4">
                ...
                <ol class="breadcrumb">
                    <li id="btimprime" class="puntero"><a><i class="fa fa-print"></i>Listado de encargados asignados</a></li>
                </ol>
                </div>
