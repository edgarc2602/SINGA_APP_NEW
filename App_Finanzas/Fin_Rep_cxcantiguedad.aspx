<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Fin_Rep_cxcantiguedad.aspx.vb" Inherits="App_Finanzas_Fin_Rep_cxcantiguedad" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                var formula = '{sp_antiguedadsaldosfacturas;1.fecha_emision_docto} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')'
                /*if ($('#dlstatus').val() != 0) {
                ...
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=antiguedadsaldos.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
        /*
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Antigüedad de saldos de Clientes<small>Finanzas</small></h1>
                    <ol class="breadcrumb">
