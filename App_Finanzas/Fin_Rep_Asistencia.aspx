<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Fin_Rep_Asistencia.aspx.vb" Inherits="App_Finanzas_Fin_Rep_Asistencia" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                var formula = '{tb_empleado.tipo} = 2 and {tb_empleado.id_status} in [2, 3] and {tb_empleado_asistencia.fecha} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')'                
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=asistenciaimss.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
    </script>
</head>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte de Asistencia<small>Finanzas</small></h1>
                    <ol class="breadcrumb">
