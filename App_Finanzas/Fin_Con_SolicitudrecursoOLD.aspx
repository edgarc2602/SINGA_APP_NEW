...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function cuentasolicitud() {
            PageMethods.contarsolicitud($('#txfecini').val(), $('#txfecfin').val(), $('#txfolio').val(), $('#dlcliente').val(), $('#txnoemp').val(), $('#dlstatus').val(), function (cont) {
        ...
        function cargalista() {
            //waitingDialog({});
            PageMethods.solicitudes($('#txfecini').val(), $('#txfecfin').val(), $('#txfolio').val(), $('#dlcliente').val(), $('#hdpagina').val(), $('#txnoemp').val(), $('#dlstatus').val(), function (res) {
                //closeWaitingDialog();
                    ...
                    $('#tblista tbody tr').on('click', '.btdetalle', function () {
                        switch ($(this).closest('tr').find('td').eq(6).text()) {
                            ...
                            default:
                                ...
                                $('#lbconcepto').text($(this).closest('tr').find('td').eq(11).text());
