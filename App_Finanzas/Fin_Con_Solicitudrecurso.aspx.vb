...
Partial Class App_Finanzas_Fin_Con_Solicitudrecurso
    ...
    Public Shared Function cambiaestatus(ByVal req As Integer, ByVal status As Integer, ByVal usuario As Integer, ByVal motivo As String) As String
        ...
        'Se agrega el proceso para agregar y actualizar la provision de pago
        'Se Inserta en Tabla: tb_provisionpago y se Actualiza: tb_provision son la suma de tb_provisionpago.Pago
        If status = 5 Then
            Dim Result As String = provisionpago(req)
        End If
    ...
    Public Shared Function provisionpago(ByVal idsolicitud As Integer) As String
        Dim sql As String = "EXEC sp_pagoprovision " & idsolicitud & "; "
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim mycommand As New SqlCommand(sql, myConnection)
        myConnection.Open()
        mycommand.ExecuteNonQuery()
