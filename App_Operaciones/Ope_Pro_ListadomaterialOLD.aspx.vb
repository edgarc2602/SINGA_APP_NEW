...
Partial Class App_Operaciones_Ope_Pro_Listadomaterial
    ...
    Public Shared Function inmueble(ByVal cliente As Integer) As String
        ...
        sqlbr.Append("from tb_cliente_inmueble where id_status = 1 and id_cliente = " & cliente & " order by nombre for xml path('tr'), root('tbody')")
    ...
    Public Shared Function listado(ByVal inmueble As Integer, ByVal mes As Integer, ByVal anio As Integer, ByVal cliente As Integer) As String
        ...
        sqlbr.Append("where a.id_inmueble =" & inmueble & " and mes = " & mes & " and anio =" & anio & " and tipo=1;")
        sqlbr.Append("SELECT sum(importe) as totalptto from tb_cliente_inmueble a left outer join tb_cliente_material b on a.id_cliente = b.id_cliente where b.id_lineanegocio in(1,2) and a.id_inmueble = " & inmueble & " and b.id_status =1;" & vbCrLf)
