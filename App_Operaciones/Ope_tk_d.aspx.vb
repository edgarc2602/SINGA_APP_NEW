...
Imports System.IO
Partial Class App_Operaciones_Ope_tk_d
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ddlanio.DataBind()
            ddlanio.Items.Add(New ListItem("Sel. el area...", 0, True))
            ...
            'Dim grafica_mes As String = "grafica();"
            'ScriptManager.RegisterStartupScript(Me, GetType(Page), "demo", grafica_mes, True)
    ...
    Protected Sub llenagrafica()
        ...
        'grafica_mes = "demo(" & categoria & "," & Serie1 & "," & Serie2 & "," & Serie3 & ",'Grafica por Mes de servicio',0," & mes & ");"
        grafica_mes = "demo();"
        ScriptManager.RegisterStartupScript(Me, GetType(Page), "demo", grafica_mes, True)
