    ...
    <script type="text/javascript">
        ...
        $(function () {
                        ...
                        PageMethods.validacomp($('#dlsucursal').val(), $('#dlmes').val(), $('#txanio').val(), $('#dltipo').val(), function (res) {
                            ...
                            if (datos.id != 0) {
                                ...
                                PageMethods.guarda(xmlgraba, function (res) {
                                    ...
                                    $('#dvjarceria').show();
                                    if ($('#dltipo').val() == 3) {
                                        PageMethods.listadomes($('#dlsucursal').val(), $('#dlmes').val(), $('#txanio').val(), function (detalle) {
                                            var datos = eval('(' + detalle + ')');
                                            $('#txlistado').val(datos.id);
                                            $('#txptto').val(datos.ptto);
                                            $('#txusado').val(datos.usado);
                                            $('#txdisponible').val(datos.disp);
                                        }, iferror);
            ...
            $('#btbuscap').click(function () {
                PageMethods.productol($('#txbusca').val(), $('#dlsucursal').val(), function (res) {
        ...
        function cargaproducto(clave) {
            PageMethods.producto(clave, $('#dlsucursal').val(), function (detalle) {
                var datos = eval('(' + detalle + ')');
                if (datos.clave != '0') {
                    ...
                    <div class="row" id="dvdatos">
                        <div class="box box-info">
                            ...
                            <div class="row" id="dvvalidalista">
                                <div class="col-lg-1 text-right">
                                    <label for="txlistado">Listado del mes:</label>
                                </div>
                                <div class="col-lg-1">
                                    <input type="text" id="txlistado" class="form-control" disabled="disabled" />
                                </div>
                                <div class="col-lg-1 ">
