<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ope_Rep_servicioespecial.aspx.vb" Inherits="App_Operaciones_Ope_Rep_servicioespecial" %>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                if (valida()) {
                    ...
                    var formula = ''
                    formula = '{tb_servicioespecial.fregistro} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')'
                    if ($('#dlestatus').val() != 0) {
                        formula = ' and {tb_servicioespecial.id_status}=' + $('#dlestatus').val()
                    }
                    //alert(formula);
                    window.open('../RptForAll.aspx?v_nomRpt=servicioespecial.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
                }
            })
        });
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte de Servicios especiales<small>Operaciones</small></h1>
                    <ol class="breadcrumb">
