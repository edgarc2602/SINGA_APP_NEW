                        ...
                        <div id="divmodal">
                            ...
                            <div class="row ">
                                <div class="col-lg-6 radio">
                                    <input type="radio" id="rbnuevo1" name="listadop" value="1"/>
                                    <label for="rbnuevo1">Listado en blanco</label> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 radio">
                                    <input type="radio" id="rbnuevo2" name="listadop" value="2"/>
                                    <label for="rbnuevo2">Copiar listado del mes anterior</label> 
                                </div> 
                            </div>
                            <div class="row">
                                <div class="col-lg-6 radio">
                                    <input type="radio" id="rbnuevo3" name="listadop" value="3"/>
                                    <label for="rbnuevo3">Utilizar la lista tipo de este Cliente</label> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="button" id="btcontinua" class="btn btn-info">Continuar</button>
                                </div>
                            </div>
                        </div>
                        <div id="divmodal1">
