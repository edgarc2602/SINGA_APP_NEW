...
<script type="text/javascript">
    function sitemap() {
	var url="http://isatel.dnsalias.com:2017/ISATEL/sitemap/sitemap.aspx"
    window.open(url,"","")
    }
</script>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown notifications-menu">
               ...
               <li class="dropdown notifications-menu">
                <a href="sitemap/sitemap.aspx" class="dropdown-toggle" data-toggle="dropdown" onclick="sitemap();">
