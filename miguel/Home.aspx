							...
							<li>
								...
								<ul class="dl-submenu">
									<li>
										...
										<ul class="dl-submenu">
											<li>
												<a href="Ventas_App/Ven_Cotizador.aspx">Cotizacion-Alta</a>
											</li>
											<li>
												<a href="Ventas_App/Ven_Cot_Factores.aspx">Factores-Configuracion</a>
											</li>
										</ul>
									</li>
									<li>
										...
										<ul class="dl-submenu">
											<li>
												<a href="ventas_App/Ven_Con_Cotizacion.aspx">Cotizacion-Seguimiento</a>
											</li>
											<li>
												<a href="Ventas_App/Ven_Prospecto.aspx">Prospectos</a>
											</li>
											<li>
												<a href="Ventas_App/Ven_Cat_Cliente.aspx">Clientes</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<li>
								...
								<ul class="dl-submenu">
									<li>
										<a href="#">Catalogos</a>
										<ul class="dl-submenu">
											<li><a href="App_Inventarios/Inv_Cat_Almacen.aspx">Almacen</a></li>
											<li><a href="App_Inventarios/Inv_Cat_Materiales.aspx">Material</a></li>
											<li><a href="App_Inventarios/Inv_Cat_Herramientas.aspx">Herramienta</a></li>
											<li><a href="App_Inventarios/Inv_Cat_Equipo.aspx">Equipo</a></li>
											<li><a href="App_Inventarios/Inv_Cat_Uniformes.aspx">Uniformes</a></li>
											<li><a href="App_Inventarios/Inv_Cat_Precios.aspx">Precios</a></li>
										</ul>
									</li>
								</ul>
							</li>
							...
							<li>
								...
								<ul class="dl-submenu">
									<li>
										...
										<ul class="dl-submenu">
											<li>
												<a href="Admin_App/Adm_Cat_Puesto.aspx">Puestos</a>
                                            </li>
										</ul>
									</li>
									<li>
