<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LEG_Pro_cuentaempleado.aspx.vb" Inherits="App_legal_LEG_Pro_cuentaempleado" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btguarda').click(function () {
                //if ($('#idusuario').val() == 57) {
                    PageMethods.actualizabanco($('#txid').val(), $('#dlbanco').val(), $('#txclabe').val(), $('#txcuenta').val(), function () {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Cuentas de Empleados inactivos<small>Legal</small></h1>
                    <ol class="breadcrumb">
