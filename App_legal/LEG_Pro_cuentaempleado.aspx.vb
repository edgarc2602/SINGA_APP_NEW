...
Imports System.Xml
Partial Class App_legal_LEG_Pro_cuentaempleado
    ...
    Public Shared Function empleados(ByVal campo As String, ByVal valor As String) As String
        ...
        sqlbr.Append("where a.id_status = 3")
    ...
    <Web.Services.WebMethod()>
    Public Shared Function actualizabanco(ByVal emp As Integer, ByVal banco As Integer, ByVal clabe As String, ByVal cuenta As String) As String
