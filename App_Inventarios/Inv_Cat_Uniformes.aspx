<%@ Page Language="VB" enableEventValidation="false" ValidateRequest="true" AutoEventWireup="false" CodeFile="Inv_Cat_Uniformes.aspx.vb" Inherits="Inventarios_App_Inv_Cat_Uniformes" %>
...
<script type="text/javascript">
    ...
    function valida() {
        ...
        if (mat == '') {
            alert("Validacion!, Capture el Uniforme");
            return false;
        }
        if (strfam == '0') {
...
<body class="skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <div class="content" >
              ...
              <!-- Horizontal Form -->
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Pza_DescPieza" HeaderText="Uniforme" SortExpression="Pza_DescPieza" />
          ...
          <ol class="breadcrumb">
            <li onclick="muestra();"><a ><i class="fa fa-dashboard"></i> Uniformes</a></li>
          </ol>
          </div>   
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Uniforme:</label>
                      <div class="col-sm-10">
                            <asp:TextBox ID="txtmat" class="form-control" placeholder="Ingrese el Uniforme" runat="server"></asp:TextBox>
                      </div>
                    </div>
                    <div class="form-group">
          ...
          <ol class="breadcrumb">
            <li onclick="muestra();"><a ><i class="fa fa-dashboard"></i> Listado de Uniformes</a></li>
            <li onclick="limpia();"><a ><i class="fa fa-dashboard"></i> Nuevo Uniforme</a></li>
          </ol>
