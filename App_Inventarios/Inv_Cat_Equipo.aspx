<%@ Page Language="VB" enableEventValidation="false" ValidateRequest="true" AutoEventWireup="false" CodeFile="Inv_Cat_Equipo.aspx.vb" Inherits="Inventarios_App_Inv_Cat_Equipo" %>
...
<script type="text/javascript">
    ...
    function valida() {
        ...
        if (mat == '') {
            alert("Validacion!, Capture el Equipo");
            return false;
        }
        if (strfam == '0') {
...
<body class="skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <div class="content" >
              ...
              <!-- Horizontal Form -->
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Pza_DescPieza" HeaderText="Equipo" SortExpression="Pza_DescPieza" />
          ...
          <ol class="breadcrumb">
            <li onclick="muestra();"><a ><i class="fa fa-dashboard"></i> Equipos</a></li>
          </ol>
          </div>   
                ...
                <!-- form start -->
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                            <asp:TextBox ID="txtmat" class="form-control" placeholder="Ingrese el Equipo" runat="server"></asp:TextBox>
                      </div>
                    </div>
                    <div class="form-group">
          ...
          <ol class="breadcrumb">
            <li onclick="muestra();"><a ><i class="fa fa-dashboard"></i> Listado de Equipos</a></li>
            <li onclick="limpia();"><a ><i class="fa fa-dashboard"></i> Nuevo Equipo</a></li>
          </ol>
