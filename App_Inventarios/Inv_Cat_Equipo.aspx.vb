...
Partial Class Inventarios_App_Inv_Cat_Equipo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Dim sql As String = "SELECT IdFamilia, Convert(nvarchar(4),IdFamilia) +' - '+ PzaF_DescFamilia as PzaF_DescFamilia FROM Tbl_Pza_Familia where Pza_Tipo=3"
    ...
    Protected Sub consulta()
        ...
        Sql += " FROM Tbl_Pieza where Pza_Tipo=3"
        Dim myCommand As New SqlDataAdapter(Sql, myConnection)
        Dim dt As New DataTable
        myCommand.Fill(dt)
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        datos = lblid.Text & "#" & txtcve.Text & "#" & txtmat.Text & "#" & ddlum.SelectedValue & "#" & ddlfam.SelectedValue & "#" & ddlstatus.SelectedValue & "###0#0#0#0#2#0#3#"
        graba(datos)
    End Sub
