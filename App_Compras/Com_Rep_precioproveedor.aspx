<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Rep_precioproveedor.aspx.vb" Inherits="App_CGO_Com_Rep_precioproveedor" %>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                if ($('#dlproveedor').val() != 0) {
                    formula = '{tb_proveedor.id_proveedor}=' + $('#dlproveedor').val()
                }
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=matrizpreciosproveedor.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        });
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Precios de materiales por Proveedor<small>Compras</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../Home.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a>Compras</a></li>
                        <li class="active">Precios de materiales</li>
                    </ol>
                </div>
                <div class="content">
