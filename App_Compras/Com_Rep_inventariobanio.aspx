<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Rep_inventariobanio.aspx.vb" Inherits="App_Compras_Com_Rep_inventariobanio" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                var formula = '{tb_cliente_inmueble.id_cliente} = 130 and {tb_cliente_inmueble.id_status} = 1 and not { tb_cliente_inmueble.materiales }'
                if ($('#dlproveedor').val() != 0) {
                    formula += ' and {tb_proveedor.id_proveedor}=' + $('#dlproveedor').val()
                }
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=inventariobanios.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        });
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Inventario de baños por proveedor<small>Compras</small></h1>
                    <ol class="breadcrumb">
