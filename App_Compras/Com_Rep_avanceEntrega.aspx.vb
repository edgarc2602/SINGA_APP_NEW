...
Partial Class App_Compras_Com_Rep_avanceEntrega
    ...
    Public Shared Function comprador() As String
        ...
        sqlbr.Append("select id_empleado, Nombre + ' ' + paterno + ' ' + rtrim(Materno)  as comprador from tb_empleado where id_puesto = 53 and id_status =2 order by comprador")
