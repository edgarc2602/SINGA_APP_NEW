<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Pro_Solicitudmaterial.aspx.vb" Inherits="App_Compras_Com_Pro_Solicitudmaterial" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btguarda').click(function () {
                if (valida()) {
                    waitingDialog({});
                    var xmlgraba = '<movimiento> <solicitud id="' + $('#txfolio').val() + '" solicita="' + $('#txsolicita').val() + '" id_inmueble="' + $('#dlinmueble').val() + '" id_servicio="1" ';
            ...
            $('#dlcliente').change(function () {
                ...
                if ($('#dlcliente').val() != 0) {
                    cargasucursales($('#dlinmueble').val());
                }
                else {
                    $('#dlinmueble').html(inicial);
                }
        ...
        function cargasucursales() {
            ...
            else if ($('#dlcliente').val() > 0) {
                idcliente = $('#dlcliente').val()
            }

            PageMethods.sucursales(idcliente, function (opcion) {
                if (opcion == '') {
                    alert("No hay sucursales agregadas");
                }
                else if (opcion == 'error') {
                    alert("Ocurrió un error, favor de reportárlo al área de sistemas");
                }
                else {
                    var opt = eval('(' + opcion + ')');
                    var lista = '';
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Solicitud de Materiales de Mantenimiento<small>Compras</small></h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row" id="dvdatos">
                        <div class="box box-info">
                            ...
                            <div class="row">                                
                                ...
                                <div class="col-lg-1 text-right">
                                    <label for="dlcliente">Sucursal:</label>
                                </div>
                                <div class="col-lg-3">
