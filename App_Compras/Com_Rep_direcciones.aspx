<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Rep_direcciones.aspx.vb" Inherits="App_Compras_Com_Rep_direcciones" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                var formula = '{tb_cliente_inmueble.id_status} = 1 and { tb_cliente.id_status } = 1'
                if ($('#dlcliente').val() != 0) {
                ...
                window.open('../RptForAll.aspx?v_nomRpt=inmuebledireccion.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        })
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Direcciones de sucursales<small>Compras</small></h1>
                    <ol class="breadcrumb">
