<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Rep_materialconcentrado.aspx.vb" Inherits="App_Compras_Com_Rep_materialconcentrado" %>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                if ($('#dlproveedor').val() != 0) {
                    formula += ' and {tb_proveedor.id_proveedor}=' + $('#dlproveedor').val()
                }
                if ($('#dlestado').val() != 0) {
                ...
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=resumenmaterialproveedor.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        });
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Concentrado de materiales<small>Compras</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../Home.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a>Compras</a></li>
                        <li class="active">Concentrado de materiales</li>
                    </ol>
                </div>
                <div class="content">
