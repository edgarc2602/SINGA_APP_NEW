<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Pro_validapreciolistado.aspx.vb" Inherits="App_Compras_Com_Pro_validapreciolistado" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>VALIDAR PRECIOS DE MATERIALES</title>
    ...
    <script type="text/javascript">
            ...
            if (valida()) {
               // waitingDialog({});
                ...
                $('#tblista tbody tr').each(function () {
                    xmlgraba += '<partida listado="' + $(this).closest('tr').find('td').eq(0).text() +'" clave="' + $(this).closest('tr').find('td').eq(2).text() + '"';
                    xmlgraba += ' precio="' + parseFloat($(this).closest('tr').find("input:eq(0)").val()) + '" proveedor ="' + $('#dlproveedor').val() + '" />';
                });
                //xmlgraba += '</movimiento>';
                //alert(xmlgraba);
        ...
        function cargalistados() {
            PageMethods.listados($('#dlproveedor').val(), $('#dlcliente').val(), $('#txanio').val(), $('#dlmes').val(), function (res) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Validar precios de materiales<small>Compras</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../Home.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a>Compras</a></li>
                        <li class="active">Precios de material</li>
                    </ol>
                </div>
                <div class="content">
