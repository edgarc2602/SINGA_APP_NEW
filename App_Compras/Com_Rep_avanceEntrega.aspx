<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Rep_avanceEntrega.aspx.vb" Inherits="App_Compras_Com_Rep_avanceEntrega" %>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                if ($('#dlcomprador').val() != 0) {
                    formula += ' and {tb_cliente.id_comprador} =' + $('#dlcomprador').val()
                }
                //alert(formula);
                window.open('../RptForAll.aspx?v_nomRpt=avanceEntregas.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
            })
        });
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Avance de entrega de materiales<small>Compras</small></h1>
                    <ol class="breadcrumb">
