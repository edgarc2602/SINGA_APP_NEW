<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ban_Con_SolicitudD.aspx.vb" Inherits="App_Banfuturo_Ban_Con_SolicitudD" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $('#txnoemp').val($('#hdfolio').val());
            nombreempleado();
            cargalista();

        });
        function nombreempleado() {
            PageMethods.nombre($('#hdfolio').val(), function (opcion) {
                var opt = eval('(' + opcion + ')');
        ...
        function cargalista() {
            //waitingDialog({});
            PageMethods.documentos($('#hdfolio').val(), function (res) {
                //closeWaitingDialog();
                ...
                if (ren == null) {
                    ...
                    $('#tblista table tbody tr').on('click', '.tbeditar', function () {
                        ...
                        if (archivo.includes('http://diaso.com.mx/')) {
                            window.open(archivo, '_blank', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no ');
                        }
                        else {
                            window.open('../Doctos/banfuturo/Solicitud' + $('#hdfolio').val() + '/' + archivo, '_blank', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no ');
                        }
                    });
                }
            }, iferror);
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdfolio" runat="server" value="0"/>
        <div id="divinmueble" class="content">
            <div class="row" id="tblista">
                <div class="box box-info">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <label for="txnoemp">No. Folio:</label>
                        </div>
                        <div class="col-lg-1">
