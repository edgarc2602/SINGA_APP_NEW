<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGO_Pro_Asistenciaapp.aspx.vb" Inherits="App_CGO_CGO_Pro_Asistenciaapp" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>CARGA DE ASISTENCIAS DE APP</title>
    ...
    <script type="text/javascript">
            ...
            if ($('#txarchivo').val() != '') {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        //alert('hola');
                        PageMethods.gtxml(res,$('#idusuario').val(), function () {
                            cuentaasistencia();
                            cargaasistencia();
                            closeWaitingDialog();    
                        }, iferror);
        ...
        function cuentaasistencia() {
            PageMethods.contarasistencia($('#idusuario').val(), function (cont) {
                $('#paginacion li').remove();
                var opt = eval('(' + cont + ')');
                var pag = '';
        ...
        function cargaasistencia() {
            PageMethods.asistencia($('#hdpagina').val(), $('#idusuario').val(), function (res) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Carga de asistencias de APP<small>CGO</small></h1>
                    <ol class="breadcrumb">
