    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btguarda').click(function () {
                if (valida()) {
                    ...
                    xmlgraba += ' resuelve="' + $('#dlatiende').val() + '" />'
                    ...
                    PageMethods.guarda(xmlgraba, $('#txid').val(), function (res) {
                        ...
                        PageMethods.extras(res, function (detalle) {
                            ...
                            $('#idticket').val(datos.idticket);
                            $('#txfolio').val(datos.folio);
                            $('#txfecnot').val(datos.fnotifica);
                            $('#txfecesc').val(datos.fescala);
                            closeWaitingDialog();
        ...
        function cargareporte(idticket) {
            PageMethods.cargaticket(idticket, function (detalle) {
                ...
                $('#idatiende').val(datos.atiende);
                $('#txfecnot').val(datos.fnotifica);
                $('#txfecesc').val(datos.fescala);
                cargaatencion(datos.area);
                desbloqueaestado(); 
        ...
        function cargacausa() {
            PageMethods.causa($('#idincidencia').val(), function (opcion) {
                ...
                $('#dlcausa').change(function () {
                    cargahoras($('#dlcausa').val())
                })
            }, iferror);
        }
        function cargahoras(inc) {
            PageMethods.horas(inc, function (detalle) {
                var datos = eval('(' + detalle + ')');
                $('#txhoras').val(datos.horas);
            }, iferror)
        }
        function cargaarea() {
            PageMethods.area($('#cteusuario').val(), function (opcion) {
                ...
                $('#dlarea').change(function () {
                    cargaatencion($('#dlarea').val());
                })
            }, iferror);
        }
        function cargaatencion(area) {
            PageMethods.atiende(area, function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
                for (var list = 0; list < opt.length; list++) {
                    lista += '<option value="' + opt[list].id + '">' + opt[list].desc + '</option>';
                ...
                $('#dlatiende').empty();
                $('#dlatiende').append(inicial);
                $('#dlatiende').append(lista);
                $('#dlatiende').val(0);
                if ($('#idatiende').val() != 0) {
                    $('#dlatiende').val($('#idatiende').val());
                } else { $('#dlatiende').val(0); }
            });
        }
        /*
...
<body class="skin-blue sidebar-mini">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="idatiende" runat="server" />
        <div class="wrapper">
                ...
                <div class="content">
                    <div class="row" id="dvdatos">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="row">
                                    <div class="col-lg-2  text-right">
                                         <label for="dlarea">Area resposable:</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <select id="dlarea" class="form-control" ></select>
                                    </div>
                                    <div class="col-lg-2 text-right">
                                        <label for="txatencion">Tiempo de atención:</label>
                                    </div>
                                    <div class="col-lg-1">
                                        <input class="form-control" type="text" id="txhoras" value="0" disabled="disabled"/>
                                    </div>
                                    <div class="col-lg-1">
                                        <label for="txatencion">horas</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-2  text-right">
                                         <label for="dlatiende">Persona que atiende:</label>
                                    </div>
                                    <div class="col-lg-3">
                                        <select id="dlatiende" class="form-control" ></select>
                                    </div>
                                    <div class="col-lg-2 text-right">
                                        <label for="txfecnot">F. Notifica:</label>
                                    </div>
                                    <div class="col-lg-2">
                                        <input class="form-control" type="text" id="txfecnot" disabled="disabled"/>
                                    </div>
                                    <div class="col-lg-1 text-right">
                                        <label for="txfecesc">F. Escala:</label>
                                    </div>
                                    <div class="col-lg-2">
                                        <input class="form-control" type="text" id="txfecesc" disabled="disabled"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-2  text-right">
