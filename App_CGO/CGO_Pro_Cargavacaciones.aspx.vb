...
Imports System.Xml
Partial Class App_CGO_CGO_Pro_Cargavacaciones
    ...
    Public Shared Function empleado(ByVal pagina As Integer, ByVal cliente As String, ByVal inmueble As String, ByVal noemp As String, ByVal nombre As String, ByVal tipo As Integer, ByVal forma As Integer, ByVal estatus As Integer) As String
        ...
        sqlbr.Append("estatus as 'td','', cliente as 'td','', inmueble as 'td' from (" & vbCrLf)
    ...
    Public Shared Function actualiza(ByVal empleado As String, ByVal archivo As String) As String
        ...
        Dim sql As String = "insert into tb_empleado_vacacion (id_empleado, fcarga, archivo) values (" & empleado & ", getdate(), '" & archivo & "');"
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
    ...
    Public Shared Function documentos(ByVal emp As Integer) As String
        ...
        sqlbr.Append("select convert(varchar(10), fcarga, 103) as 'td','', archivo as 'td',''," & vbCrLf)
        ...
        sqlbr.Append("from tb_empleado_vacacion where id_empleado = " & emp & " for xml path('tr'), root ('tbody')")
