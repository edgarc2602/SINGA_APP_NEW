<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Man_Rep_Estimacion.aspx.vb" Inherits="App_Mantenimiento_Man_Rep_Estimacion" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btimprime').click(function () {
                ...
                if (valida()) {
                    var formula = '{tb_ordentrabajo.id_cliente} =' + $('#dlcliente').val() + ' and {tb_regionentrega.id_region} =' + $('#dlregion').val() + ' and {tb_ordentrabajo.id_status} = 3' + ' and {tb_ordentrabajo.fregistro} in Date (' + fini[2] + ' , ' + fini[1] + ' , ' + fini[0] + ') to Date (' + ffin[2] + ' , ' + ffin[1] + ' , ' + ffin[0] + ')';
                    console.log(formula);
                    window.open('../RptForAll.aspx?v_nomRpt=estimacionesmantenimiento.rpt&v_formula=' + formula, '', 'width=850, height=600, left=80, top=120, resizable=no, scrollbars=no');
                }                               
        ...
        function cargaRegiones() {
            var idcliente = $('#dlcliente').val();

            PageMethods.regiones(idcliente, function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Reporte Estimación<small>Mantenimiento</small></h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="box box-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1 text-right">
                                    <label for="dlregion">Region:</label>
                                </div>
                                <div class="col-lg-2">
                                    <select id="dlregion" class="form-control">
                                    </select>
                                </div>
