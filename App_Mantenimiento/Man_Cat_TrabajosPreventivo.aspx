<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Man_Cat_TrabajosPreventivo.aspx.vb" Inherits="App_Mantenimiento_Man_Cat_TrabajosPreventivo" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>TRABAJOS PREVENTIVO</title>
    ...
    <script type="text/javascript">
        ...
        function cargalista() {
            PageMethods.trabajospreventivo( $('#hdpagina').val(), function (res) {
        ...
        function cuentatrabajos() {
            PageMethods.contartrabajos(function (cont) {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Trabajos Preventivo<small>Mantenimiento</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../Home.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a>Mantenimiento</a></li>
                        <li class="active">Trabajos Preventivo</li>
                    </ol>
                </div>
                <div class="content">
                        ...
                        <div class="box box-info">
                            ...
                            <div class="row">
                                <div class="col-lg-2 text-right">
                                    <label for="dlcliente">Trabajo:</label>
                                </div >
                                <div class="col-lg-3">
