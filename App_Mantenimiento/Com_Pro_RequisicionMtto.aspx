<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Com_Pro_RequisicionMtto.aspx.vb" Inherits="App_Mantenimiento_Com_Pro_Requisicion" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btcargac1').click(function () {
                if (validaconc()) {
                    $("#divmodal3").dialog('option', 'title', 'Seleccionar datos para concentrado');
                    dialog3.dialog('open');
                }
            })
        ...
        function cargasolicitudcm() {
            PageMethods.solicitudcm($('#dlcm').val(), $('#dlsolicitudm').val(), function (res) {
                var ren1 = $.parseHTML(res);
        ...
        function cargacorrectivo() {
            PageMethods.correctivo(function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
                ...
                $('#dlcm').change(function () {
                    cargasolicitdm($('#dlcm').val());
            });

        }, iferror);
        }          
        function cargasolicitdm(correctivo) {
            PageMethods.solicitudm(correctivo, function (opcion) {
                var opt = eval('(' + opcion + ')');
                var lista = '';
                for (var list = 0; list < opt.length; list++) {
                    lista += '<option value="' + opt[list].id + '">' + opt[list].desc + '</option>';
                ...
                $('#dlsolicitudm').empty();
                $('#dlsolicitudm').append(inicial);
                $('#dlsolicitudm').append(lista);
                if ($('#idsolicitudm').val() != 0) {
                    $('#dlsolicitudm').val($('#idsolicitudm').val());
                }
            }, iferror);
        }
        function limpia() {
...
<body class="skin-blue sidebar-mini">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="idcm" runat="server" Value="0" />
        <asp:HiddenField ID="idsolicitudm" runat="server" Value="0" />
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <h1>Requisición de Compra<small>Mantenimiento   </small></h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row" id="dvdatos">
                        ...
                        <div class="box box-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <input type="button" class="form-control btn btn-primary" value="Cargar concentrado" id="btcargac1" />
                                </div>
                                 <div class="col-lg-2">
                                    <input type="button" class="form-control btn btn-primary" value="Cargar Sol.Correctivo" id="btcargac" />
                                </div>
                                <div class="col-lg-1 text-right">
                            ...
                            <div id="divmodal2">
                                <div class="row">
                                    <div class="row">
                                        <div class="col-lg-3 text-right">
                                            <label for="dlcm">Correctivo Mayor:</label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select id="dlcm" class="form-control"></select>
                                        </div>
                                    </div>
                                    
                                    <div class="row">
                                        <div class="col-lg-3 text-right">
                                            <label for="dlsolicitudm">Solicitud de Materiales:</label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select id="dlsolicitudm" class="form-control"></select>
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <input type="button" class="btn btn-primary" value="Cargar Solicitud Materiales" id="btbuscac1" />
                                        </div>
                                    </div>
