<%@ WebHandler Language="VB" Class="GH_UpReporte" %>

Imports System
Imports System.Web
Imports System.IO

Public Class GH_UpReporte : Implements IHttpHandler
        ...
        If context.Request.Files.Count > 0 Then
            ...
            For x As Integer = 0 To files.Count - 1
                ...
                If context.Request.Form("") = "" Then
                    nm = "reporte" & orden & "." & dts(1)
                Else
                    nm = "reporte" & orden & context.Request.Form("nmr") & "." & dts(1)
                End If
