...
Public Class correodir

    Public Function liberanomina(ByVal periodo As Integer, ByVal tipo As String, ByVal anio As Integer) As String
        Dim sqlbr As New StringBuilder

        Dim fecha As Date = Date.Now
        Dim per As String = periodo.ToString() & " " & tipo & " " & anio.ToString()
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, el área de Dirección ha liberado el pago de nómina " & tipo & " favor de ingresar a SINGA para descargar la nómina autorizada, el período aplicado es el siguiente:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
    ...
    Public Function rechazanomina(ByVal periodo As Integer, ByVal tipo As String, ByVal anio As Integer) As String
        Dim sqlbr As New StringBuilder
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, el área de Dirección ha rechazado el cálculo de nómina " & tipo & " favor de ingresar a SINGA para realizar los ajustes correspondientes, el período rechazado es el siguiente:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Período: " & per & "  </h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function liberaaguinaldo(ByVal anio As Integer, ByVal tipo As String) As String
        Dim sqlbr As New StringBuilder
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Liberación de pago de aguinaldo</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, la Dirección general ha liberado el pago de aguinaldo para la nómina " & tipo & " favor de ingresar a SINGA para descargar y aplicar el pago, el período aplicado es el siguiente:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
    ...
    Public Function solicitudprestamo(ByVal solicitud As Integer, ByVal usuario As Integer, ByVal autoriza As Integer) As String
        Dim sqlbr As New StringBuilder
        ...
        Dim sql As String = ""
        sql = "select id_solicitud, b.paterno +' '+ rtrim(b.materno) + ' ' + b.nombre as empleado, a.monto, " & vbCrLf
        sql += "cast(a.plazo as varchar) + ' meses' as plazo, case when a.planpago = 1 then 'Semanal' else 'Quincenal' end as planpago" & vbCrLf
        sql += "from tb_solicitudprestamo a inner join tb_empleado b on a.id_empleado = b.id_empleado" & vbCrLf
        sql += "where id_solicitud = " & solicitud & ";" & vbCrLf
        sql += "select per_email from personal where IdPersonal = " & usuario & ";" & vbCrLf
        sql += "select per_email from personal where idpersonal = " & autoriza & ";"
        Dim da As New SqlDataAdapter(sql, myConnection)
        Dim dt As New DataSet
        da.Fill(dt)
        If dt.Tables(0).Rows.Count > 0 Then
            destinos += dt.Tables(1).Rows(0)("per_email") + ";"
            destinos += dt.Tables(2).Rows(0)("per_email")
        End If
        sqlbr.Append("<html style=""width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;"">" & vbCrLf)
        sqlbr.Append("<head>" & vbCrLf)
        sqlbr.Append("<meta charset=""UTF-8"">" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td class=""es-m-txt-c"" align=""right"" style=""padding:0;Margin:0;padding-top:15px;padding-bottom:20px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#FFFFFF;"">Fecha:  " & Date.Today() & "</p><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#FFFFFF;"" id=""txfechaenvio""></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Solicitud de prestamo</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, se ha registrado la solicitud de prestamo a empleado No:" & solicitud & " por parte de Banfuturo, será necesario que ingrese a SINGA para revisar y autorizar en su caso dicha solicitud, los datos son los siguientes:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Empleado: " & dt.Tables(0).Rows(0)("empleado") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Monto: " & dt.Tables(0).Rows(0)("monto") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Plazo del prestamo: " & dt.Tables(0).Rows(0)("plazo") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Plan de pagos: " & dt.Tables(0).Rows(0)("planpago") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function solicitudautoriza(ByVal solicitud As Integer, ByVal estado As String) As String
        Dim sqlbr As New StringBuilder

        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim destinos = "debora@grupobatia.com.mx;"
        'Dim destinos = "evairt@grupobatia.com.mx;victorr@grupobatia.com.mx;"
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, la solicitud de prestamo No:" & solicitud & "  ha sido " & estado & " , será necesario que ingrese a SINGA para confirmar el estatus de la solicitud, los datos son los siguientes:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Empleado: " & dt.Tables(0).Rows(0)("empleado") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function solicitudlibera(ByVal solicitud As Integer) As String
        Dim sqlbr As New StringBuilder

        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim destinos = "zahavag@grupobatia.com.mx; debora@grupobatia.com.mx"
        'Dim destinos = "evairt@grupobatia.com.mx;victorr@grupobatia.com.mx;"

        Dim sql As String = ""

        sql = "select id_solicitud, b.paterno +' '+ rtrim(b.materno) + ' ' + b.nombre as empleado, a.monto, "
        sql += "c.descripcion as banco, b.cuenta, b.clabe, b.tarjeta"
        sql += " from tb_solicitudprestamo a inner join tb_empleado b on a.id_empleado = b.id_empleado "
        sql += " Left outer join tb_banco c On b.id_banco = c.id_banco"
        sql += " where id_solicitud = " & solicitud & ";"
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, la solicitud de prestamo No:" & solicitud & "  ha sido liberada por parte del área de finanzas para pago, será necesario que ingrese a SINGA para confirmar el deposito realizado al empleado, los datos son los siguientes:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Empleado: " & dt.Tables(0).Rows(0)("empleado") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Banco para deposito: " & dt.Tables(0).Rows(0)("banco") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Cuenta: " & dt.Tables(0).Rows(0)("cuenta") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Clabe: " & dt.Tables(0).Rows(0)("clabe") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Tarjeta: " & dt.Tables(0).Rows(0)("tarjeta") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function solicitudpago(ByVal solicitud As Integer) As String
        Dim sqlbr As New StringBuilder
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario, la solicitud de prestamo No:" & solicitud & "  ha sido registrada como pagada, a partir de hoy comenzaran a aplicar de forma automatica los descuentos colocados en la tabla de amortización, los datos son los siguientes:.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Empleado: " & dt.Tables(0).Rows(0)("empleado") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""left"" style=""padding:0;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Monto depositado: " & dt.Tables(0).Rows(0)("monto") & ".</p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table>" & vbCrLf)
        sqlbr.Append("</td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
