...
Public Class correocodigovalidacion
    Public Function codigoval(ByVal parametro As String) As String
        ...
        If dt.Rows.Count > 0 Then
            sql = dt.Rows(0)("correo")
        End If

        Dim destinos = sql
        'Dim destinos = "paolah@grupobatia.com.mx;danielr@grupobatia.com.mx;" '
        ...
        sqlbr.Append("<table width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"">" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Codigo de Verificación</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:10px;Margin:0;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;""></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("</table></td>" & vbCrLf)
    ...
    Protected Function envia(ByVal cuerpo As String, ByVal destino As String) As String
        ...
        'mail.To.Add()
        mail.Subject = "Codigo de verificación Banfuturo"
