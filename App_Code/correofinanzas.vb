...
Public Class correofinanzas
    ...
    Public Function solicitudrecurso(ByVal folio As Integer) As String
        ...
        sql += " else f.razonsocial end as beneficiario, case when id_clavecm != 0 then 'franciscom@grupobatia.com.mx;' else correovalida +';' end as correos, b.per_email, concepto, h.nombre as cliente"
        ...
        If dt.Tables(0).Rows.Count > 0 Then
            destinos += dt.Tables(0).Rows(0)("correos") + dt.Tables(0).Rows(0)("per_email") + ";"
        End If
    ...
    Public Function compruebasolicitud(ByVal folio As Integer) As String
        Dim sqlbr As New StringBuilder
        Dim vfecha As Date = Date.Today
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        'Dim destinos = "ricardob@grupobatia.com.mx"
        Dim destinos = "brisam@grupobatia.com.mx;contabilidad4@grupobatia.com.mx;"
        Dim sql As String = ""
        sql = "select  Per_Nombre + ' ' + Per_Paterno + ' ' + Per_Materno as solicita,  c.descripcion as tipo, d.nombre as empresa,"
        sql += " frechaza as falta, total, case when a.id_empleado != 0 then e.nombre + ' '+ e.paterno + ' ' + rtrim(e.materno)"
        sql += " else f.razonsocial end as beneficiario, b.per_email +';' as correos, motivo, concepto, h.nombre as cliente"
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario se ha registrado la comprobación de una solicitud de recursos, le agradecemos ingresar a SINGA para verificar la comprobación y poder concluir el proceso.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Solicita: " & dt.Tables(0).Rows(0)("solicita") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function rechazacomprobacion(ByVal folio As Integer) As String
        Dim sqlbr As New StringBuilder
        Dim vfecha As Date = Date.Today
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim destinos = ""
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario uno de sus comprobantes fue rechazado, debera ingresar a SINGA para revisarlo y realizar la corrección correspondiente.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Solicita: " & dt.Tables(0).Rows(0)("solicita") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
    ...
    Public Function terminasolicitud(ByVal folio As Integer) As String
        Dim sqlbr As New StringBuilder
        Dim vfecha As Date = Date.Today
        Dim myConnection As New SqlConnection((New Conexion).StrConexion)
        Dim destinos = ""
        ...
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-top:10px;padding-bottom:10px;""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"">Estimado usuario su comprobación ha sido verificada, se ha concluido el proceso de su Solicitud de Recursos.<br></p></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
        sqlbr.Append("<tr style=""border-collapse:collapse;"">" & vbCrLf)
        sqlbr.Append("<td align=""center"" style=""padding:0;Margin:0;padding-bottom:10px;padding-top:15px;""><h3 style=""Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;"">Solicita: " & dt.Tables(0).Rows(0)("solicita") & "</h3></td>" & vbCrLf)
        sqlbr.Append("</tr>" & vbCrLf)
